   ...
   <center>
    ...
    <div align="center">    
            ...
            <tr><th><font size="5px"> Update User </font>  </th></tr>
            	<%}else{%>
			<tr><th><font size="6px"> Add User </font>  </th></tr>            
            	<%}%>
            </h1>
    ...
    <tr><th style="padding: 2px"></th></tr>          
                ...
                <td style="position: fixed">  <font style="width:202px""position: fixed" color="red" > <%=ServletUtility.getErrorMessage("roleId", request)%></font></td>
                </tr>
    <tr><th style="padding: 3px"></th></tr>          
